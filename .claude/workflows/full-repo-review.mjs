...
const GROUPS = [
  ...
  },
  {
    ...
    files: [
      ...
      'src/Masthead.jsx',
      'src/Ticker.jsx',
      'src/DesktopTicker.jsx',
      'src/Sidebar.jsx',
      'src/MarketsColumn.jsx',
      'src/NewsColumn.jsx',
      'src/Price.jsx',
      'src/LineChart.jsx',
      'src/Chain.jsx',
      ...
      'src/Miners.jsx',
      'src/MinerRow.jsx',
      'src/FleetSummary.jsx',
      'src/Weather.jsx',
      'src/WxGlyph.jsx',
      'src/OnThisDay.jsx',
      'src/NetworkStatusWidget.jsx',
      'src/Kicker.jsx',
      'src/LeadImage.jsx',
      'src/Num.jsx',
      'src/StatusDot.jsx',
  ...
  },
  {
    ...
    files: [
      ...
      'tests/unit/BitcoinPanel.test.jsx',
      'tests/unit/HomePanel.test.jsx',
      'tests/unit/MinersPanel.test.jsx',
      'tests/unit/MobileApp.test.jsx',
      'tests/unit/MobileTabBar.test.jsx',
      'tests/unit/NewsPanel.test.jsx',
    ],
  },
];
